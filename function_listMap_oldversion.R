listMap <- function(myeb.area=NULL,
  ...
  # TEMP: disable maps to avoid rgdal/sp dependency
  message("Map disabled temporarily (rgdal/sp).")
  return(ggplot() + theme_void() + ggtitle(paste0(maptitle, " (map disabled)")))
  
  # ---- original code below (kept for later) ----    
